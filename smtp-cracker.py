...
# -*- coding: utf-8 -*-
#Coded By Amadou-python3
#Don't Change copyright Please :-)
#Amadou-python3
...
try:
  if os.name=='nt':
   ...
   os.system('clear')
    ...
    print("\033[91mERROR :| \nConatct Amadou-python3 AS u LIKE !\033[00m")
msg0 ="\033[91m########## verifying Your modules for smtp-cracker ########"
for i in msg0:
        sys.stdout.write(i)
        sys.stdout.flush()
        time.sleep(0.02)
...
class consumer(threading.Thread):
	...
	def connect(self,tupple,ssl=False):
		...
		try:
			...
			headers='From: <'+user+'> Amadou-python3\r\n'
			headers+='To: '+email+'\r\n'
...
<body>
	<center>
		...
		<font color="#f16f6f"><h1>[ ! ]Developped by Amadou-python3 [ ! ]</h1></font><br><br><br>
		...
		<font color="black" size="5" ><font color="red">Email :</font> onizo94k@gmail.com <br><br></font>
		<font color="black" size="5" ><font color="red">Github :</font> <a href="https://www.github.com/Amadou-python3">Click HEre</a><br><br></font>
		<h2>© Amadou-python3 2020-2021</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
			rez=s.recv(1000)
...
try:
 ...
 pass
save=open('about.txt','a').write('Hello \n Welcome to Smtp Cracker :) \n [+] Developped By Amadou-python3 \n Thanks To : #Amadou-python3 \n [*] Github > https:www.github.com/Amadou-python3')
...
(.-./`-'\.-.)  \033[93m$$    $$/ $$ | $/  $$ |   $$ |   $$ |       \033[0;96m(.-./`-'\.-.)
 `-'     `-'    \033[93m$$$$$$/  $$/      $$/    $$/    $$/         \033[0;96m`-'     `-'
               \033[91m[\033[92m+\033[91m]\033[1m(C)opyright > Github.com/Amadou-python3\033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER V2.1 DEVEL BY Amadou-python3 \033[91m[\033[92m+\033[91m]
             \033[91m[\033[92m+\033[91m]\033[92m     EMail : onizo94k@gmail.com    \033[91m[\033[92m+\033[91m]
            \033[91m[\033[92m+\033[91m]\033[94m Facebook >  https://www.fb.com/Jjfashion-traore \033[91m[\033[92m+\033[91m]
           \033[91m[\033[92m+\033[91m]   Github > www.github.com/Amadou-python3  \033[91m[\033[92m+\033[91m]''')
